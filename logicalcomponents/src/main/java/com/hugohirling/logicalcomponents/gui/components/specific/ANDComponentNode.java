 ...
 * 
 * Represents the graphical node of an AND-Component
 */
public class ANDComponentNode extends ComponentNode{
    
    public ANDComponentNode(final Pane root, final Point2D location) {
        super(root, "AND", location, 2, 1);
    }
